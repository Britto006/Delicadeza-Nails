-- Adiciona ao e-mail de nova reserva um botão "Falar com a cliente no WhatsApp"
-- (wa.me para o número da cliente, com mensagem pronta: confirmação + pergunta
-- do serviço). Assim a Caroline confirma com 1 toque, do número real dela,
-- sem CNPJ e sem custo. Recria a função de notificação.
...
begin
  ...
  -- Telefone da cliente normalizado para wa.me (dígitos + DDI 55).
